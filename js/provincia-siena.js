(() => {
  ...
  const showProvince = () => {
    ...
    map.setAttribute("aria-label", "Provincia di Siena, nessun comune selezionato");
    status.textContent = "Provincia di Siena, nessun comune selezionato.";
  };
  ...
  const showSelectedMunicipality = () => {
    ...
    map.setAttribute("aria-label", `Provincia di Siena con il comune di ${choice.textContent.trim()} evidenziato`);
  ...
  const previewMunicipality = (nextIndex) => {
    ...
    if (selectedIndex >= 0) {
      ...
      map.setAttribute("aria-label", `Provincia di Siena con i comuni di ${selectedChoice.textContent.trim()} e ${choice.textContent.trim()} evidenziati`);
...
(() => {
  ...
  const photos = [
    { source: "../assets/2026-03-29 (1).jpg", location: "Siena" },
    { source: "../assets/2026-03-29 (2).jpg", location: "Sinalunga" },
    { source: "../assets/2026-03-29 (3).jpg", location: "Montepulciano" },
    { source: "../assets/2026-03-29 (4).jpg", location: "Chiusi" },
    { source: "../assets/2026-03-29.jpg", location: "Torrita di Siena" },
    { source: "../assets/2026-06-30.jpg", location: "Chianciano Terme" },
  ];
